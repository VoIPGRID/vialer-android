...
public class CallTransferFragment extends Fragment implements KeyPadView.OnKeyPadClickListener, View.OnClickListener {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        ViewGroup keyPadViewContainer = view.findViewById(R.id.fragment_call_transfer);
        KeyPadView keyPadView = keyPadViewContainer.findViewById(R.id.key_pad_view);
        keyPadView.setOnKeyPadClickListener(this);

        mNumberInputView = view.findViewById(R.id.number_input_edit_text);
