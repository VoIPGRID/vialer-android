...
import static com.voipgrid.vialer.statistics.StatsConstants.VALUE_FAILED_NATIVE_CALL_IN_PROGRESS;
...
public class VialerStatistics {
    ...
    public static void incomingCallFailedDueToOngoingNativeCall(RemoteMessage middlewarePayload) {
        VialerStatistics
                .get()
                .withDefaults()
                .withMiddlewareInformation(middlewarePayload)
                .addValue(KEY_CALL_DIRECTION, VALUE_CALL_DIRECTION_INCOMING)
                .addValue(KEY_CALL_SETUP_SUCCESSFUL, VALUE_CALL_SETUP_FAILED)
                .addValue(KEY_FAILED_REASON, VALUE_FAILED_NATIVE_CALL_IN_PROGRESS)
                .send();
    }
