...
import com.voipgrid.vialer.PushReceiver;
...
/**
 * Listen to messages from Pushy. The backend server sends us Pushy notifications when we have
 * incoming calls.
 */
public class PushyMessagingService extends FirebaseMessagingService {
