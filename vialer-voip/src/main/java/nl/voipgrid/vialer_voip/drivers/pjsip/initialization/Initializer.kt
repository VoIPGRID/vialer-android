package nl.voipgrid.vialer_voip.drivers.pjsip.initialization
...
import nl.voipgrid.vialer_voip.drivers.pjsip.initialization.config.CodecConfigurator
import nl.voipgrid.vialer_voip.drivers.pjsip.initialization.config.endpoint.LogConfigurator
import nl.voipgrid.vialer_voip.drivers.pjsip.initialization.config.endpoint.MediaConfigurator
import nl.voipgrid.vialer_voip.drivers.pjsip.initialization.config.endpoint.UAConfigurator
...
internal class Initializer {
    ...
    private fun setupEndpoint(configuration: Configuration): PjsipEndpoint {
        ...
        endpoint.libCreate()
//        PjsipDriver.logWriter = SipLogWriter()
